...
declare module "$app/types" {
	export interface AppTypes {
		RouteId(): "/" | "/admin" | "/api" | "/api/admin" | "/api/admin/users" | "/api/admin/users/[id]" | "/api/auth" | "/api/auth/login" | "/api/auth/logout" | "/api/auth/me" | "/api/avatar" | "/api/avatar/restore" | "/api/recordings" | "/api/recordings/by-date" | "/api/recordings/dates" | "/api/recordings/mine" | "/api/recordings/[id]" | "/api/recordings/[id]/listen" | "/login" | "/logout" | "/record" | "/settings" | "/setup" | "/uploads" | "/uploads/avatars" | "/uploads/avatars/[[path]]" | "/uploads/[file]";
		RouteParams(): {
		...
		Pathname(): "/" | "/admin" | "/api/admin/users" | `/api/admin/users/${string}` & {} | "/api/auth/login" | "/api/auth/logout" | "/api/auth/me" | "/api/avatar" | "/api/avatar/restore" | "/api/recordings" | "/api/recordings/by-date" | "/api/recordings/dates" | "/api/recordings/mine" | `/api/recordings/${string}` & {} | `/api/recordings/${string}/listen` & {} | "/login" | "/logout" | "/record" | "/settings" | "/setup" | `/uploads/avatars${string}` & {} | `/uploads/${string}` & {};
